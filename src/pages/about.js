	...
	<Layout>
		...
		<div>
			...
			<p>
				...
				in terms of quality before hitting that "Publish" button. If you want to master something, teach it. —
				Richard Feynman I'm a huge fan of open source software, hence trying to contribute as much as possible.
				You can find all my contributions on my GitHub profile. Outside the world of software it's likely to
				find me playing games, spending time with my family and friends or trying to stop my cat from going
				insane. * = Mostly. If you think I'm spreading nonsense please get in touch with me and let's talk about
				it!
			</p>
